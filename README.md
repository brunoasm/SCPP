...
Modifications were done mostly to return functionality to scripts that had problems with newer versions of dependencies. The following files were modified:
